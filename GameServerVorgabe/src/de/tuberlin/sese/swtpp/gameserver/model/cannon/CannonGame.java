...
private static int counter =0;
	...
	public String getBoard() {
		if (counter==0)setBoard(STARTPOSITION);
		System.out.println("2. GetBoard");
		return Board.getBoard();

	}

	/**
	 * TODO finish Methode Player can player perform another Move
	 */
	@Override
